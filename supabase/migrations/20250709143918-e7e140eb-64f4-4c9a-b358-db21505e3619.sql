...
-- Update worker_hospedaje to reference global_workers
...
-- Update RLS policies for worker_hospedaje to work with global_workers
...
WHERE worker_hospedaje.worker_id = w.id;